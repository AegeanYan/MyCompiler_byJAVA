...
public class BuiltInitor {
    public globalScope init (globalScope initScope){
        ...
        class_scope.add_Func("length" , new FuncDefNode(new ClassTypeNode("int" , new position(-1 , -1)) , "int" , "length" , null , null , new position(-1 , -1)).setBuiltin());
        ...
        class_scope.add_Func("substring" , new FuncDefNode(new ClassTypeNode("string" , new position(-1 , -1)) , "string" , "substring" , vardef_list , null , new position(-1 , -1)).setBuiltin());
        class_scope.add_Func("parseInt" , new FuncDefNode(new ClassTypeNode("int" , new position(-1,-1)) , "int" , "parseInt" , null , null , new position(-1 , -1)).setBuiltin());
        vardef_list = new ArrayList<>();
        vardef_list.add(new VarDefNode(new ClassTypeNode("int" , new position(-1,-1)) , "pos" , null , new position(-1,-1)));
        class_scope.add_Func("ord" ,new FuncDefNode(new ClassTypeNode("int" , new position(-1,-1)) , "int" , "ord" , vardef_list , null ,new position(-1,-1)).setBuiltin());
